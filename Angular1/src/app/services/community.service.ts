...
export class CommunityService {
  ...
  private apiUrl = `${environment.apiBaseUrl}/api/communities`;
 ...
 isMember(communityId: number, userId: number): boolean {
  ...
  return this.http.post<Forum>(
    `${environment.apiBaseUrl}/api/forums/community/${communityId}`,
    forum,
    { headers }
  );
}
  ...
  return this.http.put<Forum>(
    `${environment.apiBaseUrl}/api/forums/${forum.id}`,
    forum,
    { headers }
  );
}
...
deleteForum(communityId: number, forumId: number): Observable<any> {
  ...
  return this.http.delete(
    `${environment.apiBaseUrl}/api/forums/${forumId}`,
