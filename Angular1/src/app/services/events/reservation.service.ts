...
export class ReservationService {
  private readonly base = `${environment.apiBaseUrl}/api/reservations/events`;
  ...
  getTicketsByReservation(reservationId: number): Observable<EventTicket[]> {
    const eventsEndpoint = `${environment.apiBaseUrl}/api/tickets/events/reservation/${reservationId}`;
    const legacyEndpoint = `${environment.apiBaseUrl}/api/tickets/reservation/${reservationId}`;
  ...
  scanTicketByCode(ticketCode: string): Observable<EventQrScanResult> {
    ...
    const eventsEndpoint = `${environment.apiBaseUrl}/api/tickets/events/scan/${encodedCode}`;
    const legacyEndpoint = `${environment.apiBaseUrl}/api/tickets/${encodedCode}/validate`;
