...
export class ArtisanService {
  private apiUrl = `${environment.apiBaseUrl}/api/ecommerce/artisan`;
  ...
  getAllArtisans(): Observable<Artisan[]> {
    return this.http.get<Artisan[]>(`${environment.apiBaseUrl}/api/ecommerce/admin/artisans`);
  }
  ...
  getArtisanDetails(artisanId: number): Observable<{
    ...
    return this.http.get<any>(`${environment.apiBaseUrl}/api/ecommerce/admin/artisans/${artisanId}`);
  }

  suspendArtisan(artisanId: number): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${environment.apiBaseUrl}/api/ecommerce/admin/artisans/${artisanId}/suspend`, {});
  }

  activateArtisan(artisanId: number): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${environment.apiBaseUrl}/api/ecommerce/admin/artisans/${artisanId}/activate`, {});
  }
}
