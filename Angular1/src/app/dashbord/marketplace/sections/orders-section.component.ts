...
export class OrdersSectionComponent implements OnInit {
  ...
  loadOrders() {
    this.isLoading = true;
    this.http.get<any>(`${environment.apiBaseUrl}/api/ecommerce/orders`).subscribe(
      (data) => {
  ...
  updateOrderStatus(orderId: number, newStatus: string) {
    ...
    this.http.patch(`${environment.apiBaseUrl}/api/ecommerce/orders/${orderId}/status`, { status: newStatus }).subscribe(
      (updated: any) => {
  ...
  deleteOrder(orderId: number) {
    if (confirm('Êtes-vous sûr de vouloir supprimer cette commande ?')) {
      this.http.delete(`${environment.apiBaseUrl}/api/ecommerce/orders/${orderId}`).subscribe(
        () => {
