...
export class DealsSectionComponent implements OnInit {
  ...
  generateWithAI(): void {
    ...
    this.http.post<AiGenerateResponse>(
      `${environment.apiBaseUrl}/api/deals/ai-generate`,
  ...
  loadDeals() {
    this.isLoading = true;
    this.error = null;
    this.http.get<any>(`${environment.apiBaseUrl}/api/ecommerce/deals`).subscribe(
      (data) => {
  ...
  createDeal() {
    ...
    this.http.post<any>(`${environment.apiBaseUrl}/api/ecommerce/deals`, dealData).subscribe(
      (response) => {
        ...
        if (this.selectedFile) {
          ...
          this.http.put<any>(
            `${environment.apiBaseUrl}/api/ecommerce/deals/${newDeal.id}`,
  ...
  updateDeal() {
    ...
    this.http.put<any>(
      `${environment.apiBaseUrl}/api/ecommerce/deals/${this.selectedDeal.id}`, dealData
    ).subscribe(
      (response) => {
  ...
  deleteDeal(dealId: number) {
    if (confirm('Are you sure you want to delete this deal?')) {
      this.http.delete(`${environment.apiBaseUrl}/api/ecommerce/deals/${dealId}`).subscribe(
  ...
  uploadDealImage(dealId: number): void {
    ...
    this.http.post<any>(
      `${environment.apiBaseUrl}/api/ecommerce/deals/${dealId}/image`, formData
    ).subscribe(
      (response) => {
