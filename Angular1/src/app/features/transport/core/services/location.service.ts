...
export class LocationService {
  ...
  getContractPdfUrl(id: number): string {
    return `${environment.apiBaseUrl}/hypercloud/reservations-location/${id}/contract-pdf`;
  }

  getFinalInvoicePdfUrl(id: number): string {
    return `${environment.apiBaseUrl}/hypercloud/reservations-location/${id}/final-invoice-pdf`;
  }
